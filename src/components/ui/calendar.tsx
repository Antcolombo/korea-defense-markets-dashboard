  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(buttonVariants({ variant: 'outline', size: 'icon-sm' }), 'h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100'),
        nav_button_previous: 'absolute left-1',
        nav_button_next: 'absolute right-1',
        table: 'w-full border-collapse space-y-1',
        head_row: 'flex',
        head_cell: 'w-9 rounded-md text-[0.68rem] font-normal text-muted-foreground',
        ...
        day_today: 'border border-primary/70 text-primary',
