...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Label>) {
  const { error, formItemId } = useFormField()
  return <LabelPrimitive.Label className={cn(error && 'text-destructive', className)} htmlFor={formItemId} {...props} />
}
